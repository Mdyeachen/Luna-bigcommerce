    ...
    addProductToCart(event, form) {
        ...
        utils.api.cart.itemAdd(normalizeFormData(new FormData(form)), (err, response) => {
            ...
            if (errorMessage) {
                ...
                $("ul.tabs li a[href$='#summary']").parent().removeClass("is-active");
                $("ul.tabs li a[href$='#customize']").parent().addClass("is-active");
                $("#summary").removeClass("is-active");
                $("#customize").addClass("is-active");
